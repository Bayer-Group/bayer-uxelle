...
Pull requests are merged using **squash merge**, so all commits in your PR will be combined into a single commit on the target branch. The PR title and description become the commit message, so please make sure they clearly describe the change.
